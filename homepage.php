...
<div>
 ...
 <div class="ddd1" style="float: right;"> 
   ...
   <a href="signup.php"><button style="width: 130px; " class="in" > sign up</button> </a>
    ...
    <input type="search" name="searchaw" style="width: 300px;height: 43px; size: 30px;border:none  ;background-color: pink;size: 30px; border-radius: 0px;" class="in" placeholder="search" value="" required>
    	<input type="submit" style="border: solid black; background-color: black; color: white; height: 40px; "class="in" value="search" >
 </div>
...
<form name="fo1" style="width:300px" method="post" onSubmit="return check()">  
  <div >  
    ...
    <input type="email" id="em" name="email" placeholder="Email" style="width: 500px;  height: 40px; border-radius: 0px; background-color: lightgreen;  border: none white; margin-left: 500px;" required>  
  ...
  <div class="form-group">  
   ...
   border: none; margin-left: 500px;" required>
